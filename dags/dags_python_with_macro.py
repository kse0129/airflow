...
with DAG(
    ...
    @task(task_id='task_using_macros',
          templates_dict={
            ...
            'end_date':'{{ (data_interval_end.in_timezone("Asia/Seoul") + macros.dateutil.relativedelta.relativedelta(day=1) + macro.dateutil.relativedelta.relativedelta(days=-1)) | ds }}'})
